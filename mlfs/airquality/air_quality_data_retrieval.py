...
def get_historical_data_for_date(
    date: str, feature_view, weather_fg, model
) -> pd.DataFrame:
    """
...
def get_historical_data_in_date_range(
    date_start: str, date_end: str, feature_view, weather_fg, model
) -> pd.DataFrame:
    """
    ...
    batch_data = batch_data[
        (batch_data["date"] >= date_start) & (batch_data["date"] <= date_end)
    ]
